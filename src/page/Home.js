  ...
  return (
    <div className='home'>
      ...
      <div className='top'>
        ...
        <button onClick={()=>filterbyName(selectedEventName)}><img src='https://img.icons8.com/ios7/600/search.png' /></button>
        </div>
        </div>
        ...
        <button onClick={()=>FilterbyState(InputLocation)}><img src='https://img.icons8.com/ios7/600/search.png' /></button>
        </div>
        </div>
